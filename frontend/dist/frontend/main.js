...
class Client {
     ...
     * @return Success
     */
    admin(password, database, offset, signal) {
     ...
     * @return Success
     */
    utilisateur(authorization, signal) {
     ...
     * @return Success
     */
    utilisateur2(authorization, body, signal) {
        let url_ = this.baseUrl + "/api/Utilisateur";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
     ...
     * @return Success
     */
    utilisateur3(authorization, signal) {
        let url_ = this.baseUrl + "/api/Utilisateur";
        url_ = url_.replace(/[?&]$/, "");
        let options_ = {
            method: "DELETE",
     ...
     * @return Success
     */
    notificationsAll(authorization, signal) {
     ...
     * @return Success
     */
    notifications(id, authorization, signal) {
     ...
     * @return Success
     */
    like(authorization, body, signal) {
        let url_ = this.baseUrl + "/api/Utilisateur/like";
        url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = {
...
PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PageNotFoundComponent, selectors: [["app-page-not-found"]], hostBindings: function PageNotFoundComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 10, vars: 0, consts: [["id", "body"], [1, "text"], [1, "pt-2"], [1, "pt-3"], ["type", "button", "routerLink", "/home", 1, "btn", "btn-primary", "w-100"]], template: function PageNotFoundComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _components_dashboardpage_home_home_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/dashboardpage/home/home.component */ "1r+w");
/* harmony import */ var _components_dashboardpage_add_add_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/dashboardpage/add/add.component */ "XNGX");
/* harmony import */ var _components_dashboardpage_settings_settings_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/dashboardpage/settings/settings.component */ "RS6x");
/* harmony import */ var _components_dashboardpage_dashboard_nav_dashboard_nav_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/dashboardpage/dashboard-nav/dashboard-nav.component */ "gXHc");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵdefineInjector"]({ providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_15__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _components_signuppage_signuppage_component__WEBPACK_IMPORTED_MODULE_5__["SignuppageComponent"],
        _components_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_6__["PageNotFoundComponent"],
        _components_dashboardpage_home_home_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"],
        _components_dashboardpage_add_add_component__WEBPACK_IMPORTED_MODULE_8__["AddComponent"],
        _components_dashboardpage_settings_settings_component__WEBPACK_IMPORTED_MODULE_9__["SettingsComponent"],
        _components_dashboardpage_dashboard_nav_dashboard_nav_component__WEBPACK_IMPORTED_MODULE_10__["DashboardNavComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_13__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_13__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"]] }); })();
...
HomepageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomepageComponent, selectors: [["app-homepage"]], decls: 35, vars: 1, consts: [[1, "container-fluid"], [1, "row"], ["id", "gauche-col", 1, "col-md-6", 2, "position", "relative"], [1, "display-1", 2, "border-radius", "20%", "padding", "5%", "background-color", "rgba(255, 255, 255, 0.5)", "width", "80%", "position", "absolute", "top", "50%", "left", "50%", "transform", "translate(-50% ,-50%)"], [2, "color", "brown"], [1, "display-3"], [1, "lead", 2, "color", "brown", "font-weight", "900", "font-style", "italic", "font-size", "2rem"], ["id", "droit-col", 1, "col-md-6", "m-0", "p-0"], [1, "m-0", "p-0", 2, "background-color", "rgba(255, 255, 255, 0.5)", "height", "100%", "width", "100%", "position", "relative"], [1, "rounded", "p-3", 2, "background-color", "rgba(255, 255, 255, 0.8)", "width", "80%", "position", "absolute", "top", "50%", "left", "50%", "transform", "translate(-50% ,-50%)", 3, "formGroup", "ngSubmit"], [1, "mb-3"], [1, "display-5"], ["for", "inputEmail", 1, "form-label"], ["type", "email", "id", "inputEmail", "formControlName", "inputEmail", "placeholder", "name@example.com", "required", "", 1, "form-control"], ["for", "inputPassword", 1, "form-label"], ["type", "password", "id", "inputPassword", "formControlName", "inputPassword", "placeholder", "**********", "required", "", 1, "form-control"], [1, "mb-3", "form-check", "form-switch"], ["type", "checkbox", "id", "switchResterConnecte", "formControlName", "switchResterConnecte", 1, "form-check-input"], ["for", "switchResterConnecte", 1, "form-check-label"], [1, "mb-3", "d-flex", "justify-content-between"], ["routerLink", "/inscription", 1, "text-decoration-none"], ["type", "submit", 1, "btn", "btn-primary"]], template: function HomepageComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function HomepageComponent_Template_form_ngSubmit_14_listener() { return ctx.login(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "div", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "h2", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](17, "Se connecter");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony import */ var _classes_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../classes/client */ "ISpL");
...
class AuthService {
    constructor() {
        this.client = new _classes_client__WEBPACK_IMPORTED_MODULE_1__["Client"]("localhost:8080/api");
    }
    login(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let data = new _classes_client__WEBPACK_IMPORTED_MODULE_1__["AuthenticateUtilisateur"]();
            data.email = email;
...
SignuppageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SignuppageComponent, selectors: [["app-signuppage"]], decls: 37, vars: 0, consts: [[1, "container-fluid"], [1, "row"], ["id", "droit-col", 1, "col", "m-0", "p-0"], [1, "m-0", "p-0", 2, "height", "100%", "width", "100%", "position", "relative"], [1, "rounded", "p-3", "row", 2, "background-color", "rgba(255, 255, 255, 0.75)", "width", "80%", "position", "absolute", "top", "50%", "left", "50%", "transform", "translate(-50% ,-50%)"], [1, "mb-3"], [1, "display-5", "p-0", "m-0"], [1, "col-md-6"], ["for", "validationDefault01", 1, "form-label"], ["type", "text", "id", "validationDefault01", "placeholder", "Sylejmani", "required", "", 1, "form-control"], ["for", "validationDefault02", 1, "form-label"], ["type", "text", "id", "validationDefault02", "placeholder", "Visar", "required", "", 1, "form-control"], [1, "col-md-12"], ["for", "validationDefault05", 1, "form-label"], ["type", "text", "id", "validationDefault05", "placeholder", "name@example.com", "required", "", 1, "form-control"], ["for", "validationDefault03", 1, "form-label"], ["type", "password", "id", "validationDefault03", "placeholder", "***************", "required", "", 1, "form-control"], ["for", "validationDefault04", 1, "form-label"], ["type", "password", "id", "validationDefault04", "placeholder", "***************", "required", "", 1, "form-control"], [1, "form-check", "mt-2", "col-12"], ["type", "checkbox", "value", "hey", "id", "invalidCheck2", "required", "", 1, "form-check-input"], ["for", "invalidCheck2", 1, "form-check-label"], [1, "col-12", "d-flex", "justify-content-between", "mt-3"], ["type", "submit", 1, "btn", "btn-primary"], ["routerLink", "/home", 1, "text-decoration-none", "float-end"]], template: function SignuppageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
...
/* harmony import */ var _components_signuppage_signuppage_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/signuppage/signuppage.component */ "nFM7");
...
const routes = [
    ...
    { path: 'inscription', component: _components_signuppage_signuppage_component__WEBPACK_IMPORTED_MODULE_6__["SignuppageComponent"] },
    {
        path: 'admin',
